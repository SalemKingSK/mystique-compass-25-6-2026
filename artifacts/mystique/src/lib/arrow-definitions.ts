...
// These arrows (rows, columns, diagonals with full/empty cells) are an Alexandrov/Western
// technique that adapts the 3×3 psychomatrix grid — not a classical Chinese Lo Shu practice.
